...
public class TemperatureTool : ConditionTool
{
    ...
    public void ShowTool()
    {
        ...
        GUILayout.Space(5);
        optimValue = EditorGUILayout.FloatField(new GUIContent("Optim Temperature", "The optim temperature of the tree where it grows the best"), optimValue);
        adaptabilityRange = EditorGUILayout.FloatField(new GUIContent("Adaptability Temp", "How adaptable is the range of the tree to the environment temperature."), adaptabilityRange);
        GUILayout.Space(5);
